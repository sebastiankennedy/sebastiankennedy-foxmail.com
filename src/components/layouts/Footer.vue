		...
		<div class="container">
			<div class="row footer-top">
				<div class="col-sm-5 col-lg-5">
					...
					<div class="text-md">
						<a v-for="item in contacts" v-bind:key="item.id" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank">
						...
						<div class="col-sm-4">
							...
							<ul class="list-unstyled">
								<li v-for="item in sponsor.list" v-bind:key="item.id">
									<a :href="item.link" target="_blank"><img v-title="item.title" :src="item.logo" :alt="item.title" class="footer-sponsor-link" width="98" /></a>
								</li>
							</ul>
						</div>
